...
try:
    ...
    # Step - 2 : Click on the NOTIFICATION button in the middle right
    element_locators = ['//android.widget.Button[@resource-id="com.lambdatest.proverbial:id/notification"]']
    element = get_element(driver, element_locators)
